export default function Home() {
  return (
    <div style={{ padding: '2rem', fontFamily: 'Arial, sans-serif', lineHeight: '2' }}>
      ...
      <p>
        <a href="/excuse.exe" target="_blank" rel="noopener noreferrer" download>Excuse EXE</a>
      </p>
      <p>
        <a href="/excuse.apk" target="_blank" rel="noopener noreferrer" download>Excuse APK</a>
      </p>
      <p>
